...
function PagesContextPanel() {
	...
	return (
		<div style={{ padding: "20px", minHeight: "100vh" }}>
			...
			>
				<h3 style={{ color: "var(--primary)", fontSize: "1rem", marginBottom: "8px" }}>🎯 Context-Aware Migration Panel</h3>
				{activePagePath ? (
					<div style={{ display: "flex", flexDirection: "column", gap: "4px" }}>
						...
						<div>
							Sitecore Path:{" "}
							<code style={{ color: "var(--secondary)", backgroundColor: "rgba(0,0,0,0.3)", padding: "2px 6px", borderRadius: "4px", fontSize: "0.8rem" }}>
								{activePagePath}
							</code>
						</div>
						<div>
					...
					<div style={{ color: "var(--text-muted)", fontStyle: "italic" }}>No page context selected in Pages Editor. Select a page to pre-populate migration path.</div>
				)}
			</div>

			<MigrationDashboard initialItemPath={activePagePath} title='Sitecore Content Transfer (BETA)' />
